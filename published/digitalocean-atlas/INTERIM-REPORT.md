...
> **Earlier DigitalOcean report editions are withdrawn.** Do not use their PDFs, plots, or summary claims for engineering decisions. This evidence rebuild is the only current report draft.
